...
def main():
    ...
    parser.add_argument('--train-data', default=r'E:\Pycharm\Project\BiNE-master\data\case_study\RNAInter\all BiNE_training_data.dat', help='Input graph file.')
    ...
    parser.add_argument('--vectors-u', default=r'E:\Pycharm\Project\BiNE-master\data\case_study\RNAInter\All feature vectors\vectors_miRNA64.dat',help="file of embedding vectors of U")

    parser.add_argument('--vectors-v', default=r'E:\Pycharm\Project\BiNE-master\data\case_study\RNAInter\All feature vectors\vectors_drug64.dat',help="file of embedding vectors of V")
