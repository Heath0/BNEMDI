...
if __name__ == '__main__':
    ...
    print(len(AllNode))
    feature_drug = pd.read_csv(r'vectors_drug512.dat',header=None,sep=' ').values.tolist()
    feature_miRNA = pd.read_csv(r'vectors_miRNA512.dat',header=None,sep=' ').values.tolist()
    NodeEmbedding = []
    ...
    pd.DataFrame(AllNodeBehavior).to_csv(r'ncDR BINE 64.csv',header=None,index=None)
