...
if __name__ == '__main__':
    ...
    print(len(AllNode))
    feature_drug = pd.read_csv(r'feature_drug64.csv',header=None).values.tolist()
    feature_miRNA = pd.read_csv(r'feature_miRNA64.csv',header=None).values.tolist()
    NodeEmbedding = []
    ...
    pd.DataFrame(AllNodeBehavior).to_csv(r'SM2miR3 BiNE 64.csv',header=None,index=None)
