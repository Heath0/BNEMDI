...
if __name__ == '__main__':
    ...
    print(len(AllNode))
    feature_drug = pd.read_csv(r'vectors_drug64.csv',header=None).values.tolist()
    feature_miRNA = pd.read_csv(r'vectors_miRNA64.csv',header=None).values.tolist()
    NodeEmbedding = []
    ...
    pd.DataFrame(AllNodeBehavior).to_csv(r'RNAInter BiNE 64.csv',header=None,index=None)
